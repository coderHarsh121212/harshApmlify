...
window.addEventListener("load", () => {
  ...
  if (!room) {
    ...
    function init(createOffer, partnerName) {
      ...
      pc[partnerName].ontrack = (e) => {
        ...
        if (document.getElementById(`${partnerName}-video`)) {
          ...
          {
            sessionStorage.setItem("muteother")
    ...
    function shareScreen() {
        h.shareScreen()
          .then((stream) => {
            ...
            // Update layout for screen sharing
            updateLayoutForScreenShare(true);
      ...
      function stopSharingScreen() {
        ...
        return new Promise((res, rej) => {
          ...
          .then(() => {
            ...
            // Update layout to remove screen sharing
            updateLayoutForScreenShare(false);
          })
          .catch((e) => {
            console.error(e);
          });
      }
      function updateLayoutForScreenShare(isSharing) {
        const videosContainer = document.getElementById('videos');
        const screenShareContainer = document.getElementById('local');
      
        if (isSharing) {
          videosContainer.style.width = '20%';
          screenShareContainer.style.width = '80%';
          // Move the screen share video to the screen share container
          const screenVideo = document.getElementById(`${socketId}-screen`);
          if (screenVideo) {
            screenShareContainer.appendChild(screenVideo);
          }
        } else {
          videosContainer.style.width = '100%';
          screenShareContainer.style.width = '0';
          // Move all videos back to the videos container
          while (screenShareContainer.firstChild) {
            videosContainer.appendChild(screenShareContainer.firstChild);
          }
        }
    ...
    function broadcastNewTracks(stream, type, mirrorMode = true) {
        ...
        // If this is a screen sharing stream, update the layout
        if (stream === screen) {
          updateLayoutForScreenShare(true);
        }
      }
